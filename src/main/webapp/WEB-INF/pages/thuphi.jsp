...
<div class="wrapper">
                    ...
                    <div class="col-12">
                        <div class="box">
                            <div class="box-header with-border">
                                ...
                                <button class="btn btn-primary" data-toggle="modal" href="#modalthuphi">Chia đơn
                                </button>
                            </div>
                            <div class="box-body">
    ...
    <div class="modal modal-fill fade" id="modalthuphi" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 style="color: #0b0b0b">Chỉ định thu phí</h4>
                ...
                <div class="modal-body" style="font-weight: bold; color: #0b0b0b">
                    <div class="form-group">
                        <label style="color:black">Chọn nhân viên thu phí</label><br>
                        <select id="userLogin" class="form-control">
                            ...
                            <c:forEach items="${admin}" var="lst" varStatus="loop">
                                <c:choose>
                                    <c:when test="${lst.role eq 'nvthuphi'}">
